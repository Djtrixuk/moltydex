...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: 'mpc-wallet-support-ai-agents-moltydex',
  ...
  {
    slug: 'moltydex-february-2026-shipping-recap',
    title: 'What We Shipped This Week: A Full Recap of MoltyDEX Updates',
    description: 'Complete recap of everything MoltyDEX shipped in February 2026: live swaps via Jupiter Ultra API, 96-issue security audit, Phase 3 UX improvements, new verified tokens, Molty mascot launch, and more.',
    keywords: ['MoltyDEX updates', 'shipping recap', 'Jupiter Ultra API', 'security audit', 'UX improvements', 'Solana DEX', 'x402 payments', 'live swaps', 'token verification', 'February 2026'],
    author: 'MoltyDEX Team',
    date: '2026-02-12',
    category: 'Updates',
    tags: ['updates', 'recap', 'shipping', 'security', 'UX', 'Jupiter', 'Solana', 'x402'],
    canonical: 'https://moltydex.com/blog/moltydex-february-2026-shipping-recap',
    content: '',
    optimized: true,
  },
  {
    slug: 'why-we-are-expanding-the-moltydex-ecosystem',
    title: 'Why We Are Expanding the MoltyDEX Ecosystem',
    description: 'The strategy behind new MoltyDEX ecosystem products and tokens. How building on our own SDK drives real transaction volume, proves the platform works, and creates a flywheel that benefits $MDEX holders.',
    keywords: ['MoltyDEX ecosystem', '$MDEX', 'token strategy', 'ecosystem expansion', 'swap volume', 'MoltyDEX SDK', 'Solana DEX', 'flywheel', 'product launches', 'x402'],
    author: 'MoltyDEX Team',
    date: '2026-02-12',
    category: 'Strategy',
    tags: ['strategy', 'ecosystem', 'MDEX', 'tokens', 'products', 'SDK', 'Solana'],
    canonical: 'https://moltydex.com/blog/why-we-are-expanding-the-moltydex-ecosystem',
    content: '',
    optimized: true,
  },
