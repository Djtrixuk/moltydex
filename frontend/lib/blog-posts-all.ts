...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: 'moltydex-deep-audit-security-sdk-swap-fixes',
    title: 'MoltyDEX Deep Audit: 30+ Fixes Across Security, SDK, and Swap Flow',
    description: 'Comprehensive production readiness audit of MoltyDEX covering 96 issues across security hardening, Python SDK VersionedTransaction signing fix, agent reliability improvements, frontend stability, and critical bug fixes for Jupiter error handling, BigInt slippage, and exchange rate display.',
    keywords: ['MoltyDEX audit', 'Solana DEX security', 'Python SDK fix', 'VersionedTransaction', 'Jupiter API', 'x402 payments', 'production readiness', 'swap bug fix', 'Solana security', 'agent reliability'],
    author: 'MoltyDEX Team',
    date: '2026-02-12',
    category: 'Engineering',
    tags: ['security', 'audit', 'SDK', 'engineering', 'Solana', 'production', 'x402', 'bug-fix'],
    canonical: 'https://moltydex.com/blog/moltydex-deep-audit-security-sdk-swap-fixes',
    content: '',
    optimized: true,
  },
  {
