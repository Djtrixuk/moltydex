...
export default function Home() {
  ...
  const homepageFaqs = [
    ...
    },
    {
      ...
      answer: "Getting started is easy! For humans: simply connect your wallet on the homepage and start swapping tokens. For AI agents: install the MoltyDEX SDK (npm install moltydex or pip install moltydex), configure the HTTPInterceptor with your Solana wallet, and enable autoSwap. Check out our developer documentation at /developers for detailed integration guides."
    },
    {
