 ...
 * 
 * NOTE: Schemas are defined here but NOT yet wired into routes.
 * To enable validation on a route, import and add as middleware:
 *   const { validateQuery } = require('../middleware/validation');
 *   router.get('/quote', validateQuery('quote'), async (req, res) => { ... });
 */
